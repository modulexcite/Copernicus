...
namespace Copernicus.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController()
            : this(new UserManager<User, long>(new UserStore()))
        {
        }
        ...
        public AccountController(UserManager<User, long> userManager)
        {
        ...
        /// POST: /Account/Manage
        /// </summary>
        /// <param name="model">Manage user</param>
        /// <returns>Result</returns>
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Manage(ManageUserViewModel model)
        {
            ...
            {
                // User does not have a password so remove any validation errors caused by a missing
                // OldPassword field
        ...
        /// <summary>
        /// Disposes the account controller
        /// </summary>
        /// <param name="disposing">Disposing of the user manager</param>
